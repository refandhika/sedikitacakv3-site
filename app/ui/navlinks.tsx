...
const NavLinks = () => {
    ...
    return (
        <nav className="flex flex-col lg:flex-row gap-0 lg:gap-6 text-2xl fixed z-10 bottom-[50%] lg:bottom-[15%] right-[-25%] hover:right-[0%] lg:right-[50%] hover:lg:right-[50%] translate-y-[50%] lg:translate-y-0 translate-x-0 lg:translate-x-[50%] transition-all duration-500">
