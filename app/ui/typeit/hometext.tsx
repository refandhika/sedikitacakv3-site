    ...
    return (
        ...
        <div className="w-full lg:w-2/3 py-8 px-0 lg:px-8 lg:py-0">
            <TypeIt
                ...
                <p className="text-xl mb-4">I&apos;m Refa, a full stack software developer. Currently residing in Cibinong, Bogor, Indonesia (just south of Jakarta). Professionally i work with multiple language, but mostly Javascript and PHP. For now occasionally Rust.</p>
